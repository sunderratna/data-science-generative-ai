...
model = pickle.load(open(r"C:\Users\sagar\OneDrive\Desktop\Data science with GenAI\Projects\Salary_prediction_using_linear_algorithm\linear_regression_model.pkl", 'rb'))
